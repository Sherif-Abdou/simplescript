...
impl Statement for WhileLoop {
    fn visit<'a>(
        ...
        let pre_condition_block = data.context.insert_basic_block_after(current_block, "0");
        ...
        data.builder.build_unconditional_branch(pre_condition_block);
        data.builder.position_at_end(pre_condition_block);
